    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPaymentBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                com.example.bowwow.PaymentRVModel paymentRVModel = new com.example.bowwow.PaymentRVModel(paymentName,paymentPhone,paymentAddress,paymentPlace,paymentCard,paymentNote, paymentID);
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        startActivity(new Intent(AddPaymentActivity.this,com.example.bowwow.allPaymentsActivity.class));
