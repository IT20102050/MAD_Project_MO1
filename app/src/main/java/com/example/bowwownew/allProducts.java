    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addFAB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(allProducts.this,com.example.bowwownew.AddProductActivity.class));
    ...
    private void getAllProducts(){
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                productRVModalArrayList.add(snapshot.getValue(com.example.bowwownew.ProductRVModal.class));
    ...
    private void displayBottomSheet(com.example.bowwownew.ProductRVModal productRVModal){
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(allProducts.this, com.example.bowwownew.EditProductActivity.class);
