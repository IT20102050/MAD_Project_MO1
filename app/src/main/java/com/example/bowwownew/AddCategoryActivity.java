    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addCategoryBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                com.example.bowwownew.CategoryRVModel categoryRVModel = new com.example.bowwownew.CategoryRVModel(categoryName, categoryDescription, categoryDate, categoryImage, categoryID);
